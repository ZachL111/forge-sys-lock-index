...
`forge-sys-lock-index` is centered on systems programming work in R. The technical target is: Build an R toolkit that studies lock behavior through capacity fixtures, with allocation and spill reports and fixture-scale datasets.
...
The score is deterministic. The current threshold is 183. Risk has a penalty of 7, latency has a penalty of 3, and weight contributes a bonus of 4.
